...
[![GoDoc](https://godoc.org/github.com/stormasm/nomsbolt?status.svg)](https://godoc.org/github.com/stormasm/nomsbolt)
...
We are fairly confident in the core data format, and plan to support Noms database [version `7`](https://github.com/stormasm/nomsbolt/blob/master/go/constants/version.go#L8) and forward. If you create a database with Noms today, future versions will have migration tools to pull your databases forward.
