...
import (
	...
	"github.com/stormasm/nomsbolt/cmd/noms/diff"
	...
	"github.com/stormasm/nomsbolt/go/types"
	"github.com/stormasm/nomsbolt/go/util/orderedparallel"
	"github.com/stormasm/nomsbolt/go/util/outputpager"
	"github.com/stormasm/nomsbolt/go/util/verbose"
	"github.com/stormasm/nomsbolt/go/util/writers"
...
var nomsLog = &util.Command{
	...
	Long:      "commitObject must be a dataset or object spec that refers to a commit. See Spelling Objects at https://github.com/stormasm/nomsbolt/blob/master/doc/spelling.md for details.",
	Flags:     setupLogFlags,
	Nargs:     1,
}
