...
import (
	...
	"github.com/stormasm/nomsbolt/go/util/functions"
)
...
func orderedSequenceDiffBest(last orderedSequence, current orderedSequence, changes chan<- ValueChanged, stopChan <-chan struct{}) bool {
	...
	// Ensure all diff functions have finished doing work by the time this function returns, otherwise database reads might cause deadlock - e.g. https://github.com/stormasm/nomsbolt/issues/2165.
	wg := &sync.WaitGroup{}
...
// TODO - something other than the literal edit-distance, which is way too much cpu work for this case - https://github.com/stormasm/nomsbolt/issues/2027
