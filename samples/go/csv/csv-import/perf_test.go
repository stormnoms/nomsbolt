...
import (
	...
	"github.com/stormasm/nomsbolt/go/perf/suite"
	"github.com/stormasm/nomsbolt/go/types"
	"github.com/stormasm/nomsbolt/samples/go/csv"
...
func (s *perfSuite) SetupSuite() {
	...
	err := exec.Command("go", "build", "-o", s.csvImportExe, "github.com/stormasm/nomsbolt/samples/go/csv/csv-import").Run()
