...
const (
	dbParam      = "dbName"
	nomsBaseHtml = "<html><head></head><body><p>Hi. This is a Noms HTTP server.</p><p>To learn more, visit <a href=\"https://github.com/stormasm/nomsbolt\">our GitHub project</a>.</p></body></html>"
)
